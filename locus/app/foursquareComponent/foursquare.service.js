System.register(['angular2/http', 'angular2/core', 'rxjs/add/operator/map'], function(exports_1) {
    ...
    return {
        setters:[
            ...
            function (_1) {}],
        execute: function() {
            FoursquareService = (function () {
                function FoursquareService(_http) {
                    this._http = _http;
                    this._serverUrl = "http://localhost:4000";
                }
                FoursquareService.prototype.getPopularPlaces = function (location) {
                ...
                FoursquareService.prototype.getLatLong = function (lat, long) {
                    return lat + ',' + long;
                };
            ...
            exports_1("FoursquareService", FoursquareService);
        }
    }
});
